...
},{}],"prisoner/javascript/prisoner.js":[function(require,module,exports) {
"use strict";
...
function loadPrisoner(_x) {
  return _loadPrisoner.apply(this, arguments);
}
function _loadPrisoner() {
  _loadPrisoner = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _axios.default.get(url + 'prisoner/' + id, {}).then(function (response) {
            $("#id").val(response.data.id);
            $("#name").val(response.data.name);
            $("#height").val(response.data.height);
            $("#weight").val(response.data.weight);
            $("#age").val(response.data.age)("#nationality").val(response.data.nationality);
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","prisoner/javascript/prisoner.js"], null)
//# sourceMappingURL=/prisoner.0a1d7f30.js.map