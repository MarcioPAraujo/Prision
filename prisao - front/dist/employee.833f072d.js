...
},{}],"employee/javascript/employee.js":[function(require,module,exports) {
"use strict";
...
function loadEmployee(_x) {
  return _loadEmployee.apply(this, arguments);
}
function _loadEmployee() {
  _loadEmployee = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _axios.default.get(url + 'employee/' + id, {}).then(function (response) {
            $("#id").val(response.data.id);
            $("#name").val(response.data.name);
            $("#turno").val(response.data.turno);
            $("#task").val(response.data.task);
            $("#accessLevel").val(response.data.accessLevel)("#equipament").val(response.data.equipament);
  ...
  _deleteRecord = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _axios.default.delete(url + 'employee/' + id, {}).then(function (response) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","employee/javascript/employee.js"], null)
//# sourceMappingURL=/employee.833f072d.js.map