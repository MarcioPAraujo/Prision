...
},{}],"jail/javascript/jail-register.js":[function(require,module,exports) {
"use strict";
...
function clear() {
  $("#capacity").val(""), $("#jailNumber").val(""), $("#securityLevel").val(""), $("#employee").val(""), $("#rangeData").val("50"), $("#confortLevel").val("");
}
function Loadselect() {
  _axios.default.get(url + 'employee', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#employee').append($("<option>".concat(item, "</option>")).attr("value", item.id).text(item.name));
    });
  ...
  _insert = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.post(url + 'jail', {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","jail/javascript/jail-register.js"], null)
//# sourceMappingURL=/jail-register.0a5aee01.js.map