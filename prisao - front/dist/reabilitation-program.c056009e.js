...
},{}],"reabilitation-program/javascript/reabilitation-program.js":[function(require,module,exports) {
"use strict";
...
function loadTable() {
  _axios.default.get(url + 'reabilitation-program', {}).then(function (response) {
...
function loadReabilitationProgram(_x) {
  return _loadReabilitationProgram.apply(this, arguments);
}
function _loadReabilitationProgram() {
  _loadReabilitationProgram = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _axios.default.get(url + 'reabilitation-program/' + id, {}).then(function (response) {
            $("#id").val(response.data.id);
            $("#task").val(response.data.task);
            $("#timesPerWeek").val(response.data.timesPerWeek);
            $("#duration").val(response.data.duration);
            $("#subjectOfStudy").val(response.data.subjectOfStudy)("#prisoner").val(response.prisoner.name);
          }).catch(function (error) {
            console.log(error);
          });
        case 2:
  ...
  _deleteRecord = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _axios.default.delete(url + 'reabilitation-program/' + id, {}).then(function (response) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","reabilitation-program/javascript/reabilitation-program.js"], null)
//# sourceMappingURL=/reabilitation-program.c056009e.js.map