...
},{}],"prisoner/javascript/prisoner-register.js":[function(require,module,exports) {
"use strict";
...
function clear() {
  $("#name").val(""), $("#height").val(""), $("#weight").val(""), $("#age").val(""), $("#nationality").val(""), $("#jail").val("");
}
function Loadselect() {
  _axios.default.get(url + 'jail', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#jail').append($("<option>".concat(item, "</option>")).attr("value", item.id).text(item.jailNumber));
    });
  ...
  _insert = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.post(url + 'prisoner', {
            name: $("#name").val(),
            height: $("#height").val(),
            weight: $("#weight").val(),
            age: $("#age").val(),
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","prisoner/javascript/prisoner-register.js"], null)
//# sourceMappingURL=/prisoner-register.2a4111f4.js.map