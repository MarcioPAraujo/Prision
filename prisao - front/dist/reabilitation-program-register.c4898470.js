...
},{}],"reabilitation-program/javascript/reabilitation-program-register.js":[function(require,module,exports) {
"use strict";
...
$("#clear").click( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
function clear() {
  $("#task").val(""), $("#timePerWeek").val(""), $("#duration").val(""), $("#subjectOfStudy").val(""), $("#prisoner").val("");
}
function Loadselect() {
  _axios.default.get(url + 'prisoner', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#prisoner').append($("<option>".concat(item, "</option>")).attr("value", item.id).text(item.name));
    });
  }).catch(function (error) {
    alert(error);
  });
}
$("#save").click( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var register;
...
function _insert() {
  _insert = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _axios.default.post(url + 'reabilitation-program', {
            task: $("#task").val(),
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","reabilitation-program/javascript/reabilitation-program-register.js"], null)
//# sourceMappingURL=/reabilitation-program-register.c4898470.js.map