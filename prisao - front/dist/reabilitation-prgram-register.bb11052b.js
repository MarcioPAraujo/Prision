...
},{}],"reabilitation-program/javascript/reabilitation-prgram-register.js":[function(require,module,exports) {
"use strict";
...
function Loadselect() {
  _axios.default.get(url + 'prision', {}).then(function (response) {
    $.each(response.data, function (key, item) {
      $('#prision').append($("<option>".concat(item, "</option>")).attr("value", item.id).text(item.name));
    });
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","reabilitation-program/javascript/reabilitation-prgram-register.js"], null)
//# sourceMappingURL=/reabilitation-prgram-register.bb11052b.js.map